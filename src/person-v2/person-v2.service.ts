...
export class PersonV2Service {
  ...
  async create(createPersonDto: CreatePersonV2Dto): Promise<Person> {
  ...
  async update(id: number, updatePersonDto: UpdatePersonV2Dto): Promise<Person> {
  ...
  async findByAddress(endereco: string): Promise<Person[]> {
